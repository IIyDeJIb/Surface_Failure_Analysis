...
for date, failInfo in rawData.itertuples():
	surfList, subsList, unclassList = xAndClassFailures(date, failInfo)
...
# period of the data typically means all the wells are running.
...
# 0']).rename(columns={'Unnamed: 0': 'Date'}).set_index('Date')
